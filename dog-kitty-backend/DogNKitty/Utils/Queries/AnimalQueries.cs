...
namespace Utils.Queries
{
    public class AnimalQueries
    {
        ...
        public static string INSERT_ANIMAL = "INSERT INTO kittydoggy.animal (nome, status, peso, idade, sexo, porte, tipoanimal,doacao_id) VALUES({0}, {1}, {2}, {3}, {4}, {5}, {6},{7}) RETURNING id;";
    }
}
